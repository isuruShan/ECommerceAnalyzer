...
public enum HiveQueryNames {
    ...
    DAILY_INCOME_ANALYZER("DAILY_INCOME_ANALYZER", "sales-percentages.csv", 6), //did a change in the file name and the concept of query for scenario 5
    ...
    MOST_SOLD_CREDIT_CARD_PRODUCTS("MOST_SOLD_CREDIT_CARD_PRODUCTS", "most-sold-products-using-credit-cards.csv", 10),
